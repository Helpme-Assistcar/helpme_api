...
class Service extends Model {
    ...
    super.init(
      {
        ...
        name: {
          ...
          allowNull: false,
          validate: { notNull: { msg: "Nome do serviço é obrigatório." } },
        },
  ...
  static associate(models) {
    ...
    this.hasMany(models.ProviderService, {
      foreignKey: "service_id",
      as: "providerServices",
    });
    this.belongsToMany(models.ProviderProfile, {
      through: models.ProviderService,
      foreignKey: "service_id",

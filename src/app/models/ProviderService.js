...
class ProviderService extends Model {
  static init(sequelize) {
    super.init({
      ...
      price_min: { type: Sequelize.DECIMAL(10,2), allowNull: true, validate: { min: 0 } },
      price_max: { type: Sequelize.DECIMAL(10,2), allowNull: true, validate: { min: 0 } },
      ...
      indexes: [
        { unique: true, fields: ['provider_id', 'service_id'], name: 'uq_provider_service_provider_id_service_id' }
      ]
    });
    return this;
  }
